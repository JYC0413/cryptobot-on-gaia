...
export function CryptocurrencyPriceList({ symbol }: { symbol: string }) {
  ...
  useEffect(() => {
    ...
    script.src =
      'https://widgets.coingecko.com/gecko-coin-list-widget.js'
...
export default memo(CryptocurrencyPriceList)
